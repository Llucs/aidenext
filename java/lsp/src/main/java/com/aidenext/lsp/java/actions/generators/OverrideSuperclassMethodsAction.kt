...
import com.aidenext.lsp.java.compiler.CompileTask
import com.aidenext.lsp.java.compiler.CompilerProvider
import com.aidenext.lsp.java.parser.ParseTask
import com.aidenext.lsp.java.rewrite.AddImport
import com.aidenext.lsp.java.utils.EditHelper
import com.aidenext.lsp.java.utils.FindHelper
import com.aidenext.lsp.java.utils.JavaParserUtils
import com.aidenext.lsp.java.utils.MethodPtr
import com.aidenext.lsp.java.visitors.FindTypeDeclarationAt
import com.aidenext.models.Position
import com.aidenext.preferences.internal.EditorPreferences
import com.aidenext.preferences.utils.indentationString
...
class OverrideSuperclassMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
      ...
      !data.hasRequiredData(
        com.aidenext.models.Range::class.java,
  ...
  override suspend fun execAction(data: ActionData): Any {
    val range = data[com.aidenext.models.Range::class.java]!!
    val compiler =
